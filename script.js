        ...
        <div>
            <div class="stats">
                <div class="stat">
                    <span>Hp</span>
                    <div class="bar">
                        <div class="percentage" style="width:${pokemon.stats[0].base_stat}%">
                ...
                <div class="stat">
                    <span>Attack</span>
                    <div class="bar">
                        <div class="percentage" style="width:${pokemon.stats[1].base_stat}%">
                ...
                <div class="stat">
                    <span>Defense</span>
                    <div class="bar">
                        <div class="percentage" style="width:${pokemon.stats[2].base_stat}%">
